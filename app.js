...
<div class="mini-li-row"><span class="mini-li-label">作业区域</span><span class="mini-li-val">${esc(w.areaName || '')}</span></div>
        ...
        <div class="side-desc-panel mini-side-panel">
          ...
          <ul>
            ...
            <li><b>8·AI检测失败或未检测：</b>如果ai检测失败或未检测，则给审核记录和现场核查记录的检测记录回填【ai未检测，请进行人工审核】，如果人工审核通过且输入了通过理由，则回填理由覆盖检测记录的内容。</li>
          </ul>
        </div>
      </div>
    `;
...
<div class="mini-li-row"><span class="mini-li-label">作业区域</span><span class="mini-li-val">${esc(w.areaName || '')}</span></div>
        ...
        <div class="side-desc-panel mini-side-panel">
          ...
          <ul>
            ...
            <li><b>2·作业现场：</b>不需要展示ai结果，如果ai检测异常会自动拒绝该作业，如果ai通过则会等待安管员审核，审核流程结束，工人端才会对该条作业变更状态和展示审核记录、现场核查记录。</li>
          </ul>
        </div>
      </div>
    `;
